def build_risk_plan(position, technical, option_chain):
    ...
    if entry <= 0 or cmp_price <= 0:
        return {"stop_loss": None, "target_1": None, "target_2": None, "trailing_sl": None, "pnl_pct": 0}
    ...
    return {"stop_loss": stop_loss, "target_1": target_1, "target_2": target_2, "trailing_sl": trailing_sl, "pnl_pct": pnl_pct}
